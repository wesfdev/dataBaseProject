...
CREATE TABLE HOSPITAL.HPTL_PERSONAS_TELEFONOS(
        ...
        CONSTRAINT HPTL_PERSONAS_TELEFONOS_UK PRIMARY KEY (PERSONAS_ID,TELEFONOS_ID),
...
CREATE TABLE HOSPITAL.HPTL_DOCUMENTOS(
	...
	VERSION NUMERIC(5,0) NOT NULL,
	CONSTRAINT HPTL_NODOCUMENTO_PK PRIMARY KEY(ID),
	CONSTRAINT HPTL_TDOC_PK_HPTL_DOC_FK FOREIGN KEY(TIPO_DOCUMENTO_ID) REFERENCES HOSPITAL.HPTL_TIPO_DOCUMENTOS(ID)
);
...
CREATE TABLE HOSPITAL.HPTL_PERSONA_DOCTO(
        ...
        CONSTRAINT HPTL_PERSONAS_DOCTO_UK PRIMARY KEY (PERSONAS_ID,DOCUMENTO_ID),
...
CREATE TABLE HOSPITAL.HPTL_HIS_EXAMENES (
		...
		CONSTRAINT HPTL_HIS_EXAMENES_UK PRIMARY KEY (EXAMENES_ID,HIS_DET_ID),
