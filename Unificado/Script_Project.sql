...
CREATE TABLE HPTL.HPTL_TIPO_ENFERMEDADES(
	...
	CONSTRAINT HPTL_ENF_PK_HPTL_TIP_ENF_FK FOREIGN KEY(ENFERMEDADES_ID) REFERENCES HPTL.HPTL_ENFERMEDADES(ID)
...
CREATE TABLE HPTL.HPTL_UBICACIONES(
	ID INTEGER NOT NULL,
	PAIS_ID INTEGER NOT NULL,
	DEPARTAMENTO_ID INTEGER NOT NULL,
	MUNICIPIO_ID INTEGER NOT NULL,
	CONSTRAINT HPTL_UBICACIONES_PK PRIMARY KEY(ID),
	CONSTRAINT HPTL_PAIS_PK_HPTL_UBI_FK FOREIGN KEY(PAIS_ID) REFERENCES HPTL.HPTL_PAISES(ID),
	CONSTRAINT HPTL_DEP_PK_HPTL_UBI_FK FOREIGN KEY(DEPARTAMENTO_ID) REFERENCES HPTL.HPTL_DEPARTAMENTOS(ID),
	CONSTRAINT HPTL_MUNICIPIOS_PK_HPTL_UBI_FK FOREIGN KEY(MUNICIPIO_ID) REFERENCES HPTL.HPTL_MUNICIPIOS(ID)
);
...
CREATE TABLE HPTL.HPTL_TIPOS_EXAMENES(
	...
	CONSTRAINT HPTL_EX_HPTL_TIPOS_ENF_FK FOREIGN KEY(EXAMENES_ID) REFERENCES HPTL.HPTL_EXAMENES(ID)
);
...
CREATE TABLE HPTL.HPTL_TIPOS_EQUIPOS(
	...
	CONSTRAINT HPTL_EQ_PK_HPTL_TIP_ENF_FK FOREIGN KEY(EQUIPOS_ID) REFERENCES HPTL.HPTL_EQUIPOS(ID)
);

--TABLAS PENDIENTES
HPTL.HPTL_DESCUENTOS();
HPTL.HPTL_TURNO CITAS();
HPTL.HPTL_EXPEDIENTE();